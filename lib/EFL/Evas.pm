...
sub AUTOLOAD {
    ...
    croak "&EFL::Evas::constant not defined" if $constname eq 'constant';
...
EFL::Evas - Perl bindings for Enlightenment Foundation Libraries' Evas
...
=item * Evas API: L<http://docs.enlightenment.org/auto/evas/>
...
L<http://annocpan.org/dist/EFL-Evas>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/EFL-Evas>

=item * RT: CPAN's request tracker

L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=EFL-Evas>

=item * Search CPAN

L<http://search.cpan.org/dist/EFL-Evas>
...
LGPL. EFL::Evas will have the same license as Evas itself.
